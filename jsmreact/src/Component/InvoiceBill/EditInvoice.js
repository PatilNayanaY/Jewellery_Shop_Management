...
//     }
//     else fetch(`http://localhost:9090/invoicebill/${invoiceid}`).then(respp => respp.json()).then(data => setcurrentInvoiceData(data));
//   }, [])

//   const handleOnSubmit = async (e) => {
//     e.preventDefault();
//     try {
//       let res = await fetch(`http://localhost:9090/updateInvoiceBill/${invoiceid}`, {
//         method: "POST", headers: {
